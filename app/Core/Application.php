...
final class Application
{
    ...
    public function run(): void
    {
        ...
        if(!$db->available()){$f3->route('GET /*',fn()=> $view->render('errors/setup',['title'=>'Setup required','configured'=>$config->databaseConfigured()],503));$f3->route('POST /*',fn()=>\Catch\Http\Response::json(['error'=>['code'=>'database_unavailable','message'=>'Database is not configured or unavailable.']],503));$f3->run();return;}
