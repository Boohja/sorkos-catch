...
import { initDevices } from './devices.js?v=8';
import { initCaptureTags } from './capture-tags.js?v=6';
import { initCaptureBulk } from './capture-bulk.js?v=8';
import { initCaptureView } from './capture-view.js?v=3';
import { initRelativeTime } from './relative-time.js?v=2';
import { initCaptureActionDialog, initCaptureActions } from './capture-actions.js?v=7';
...
import { initCaptureCollection } from './capture-collection.js?v=5';
